...
const options = {
  definition: {
      ...
      schemas: {
        ...
        MilkStore: {
          ...
          properties: {
            ...
            MilkType: { type: 'string', enum: ['cow', 'buffalo'], example: 'cow' },
            BuyerPrice: { type: 'number', format: 'decimal', example: 45.50 },
            TotalQty: { type: 'number', format: 'decimal', example: 100.00 },
            Date: { type: 'string', format: 'date', example: '2025-08-25' },
            FatPercentage: { type: 'number', format: 'decimal', example: 3.5 },
            TotalAmount: { type: 'number', format: 'decimal', example: 4550.00 },
            CreatedAt: { type: 'string', format: 'date-time' },
            IsDeleted: { type: 'integer', example: 0 }
          }
        },
        MilkPurchaseRequest: {
          type: 'object',
          required: ['buyerId', 'milkType', 'buyerPrice', 'totalQty', 'date', 'fatPercentage'],
          properties: {
            buyerId: { type: 'integer', example: 1 },
            milkType: { type: 'string', enum: ['cow', 'buffalo'], example: 'cow' },
            buyerPrice: { type: 'number', format: 'decimal', example: 45.50 },
        ...
        MilkDistribution: {
          ...
          properties: {
            ...
            MilkType: { type: 'string', enum: ['cow', 'buffalo'], example: 'cow' },
            SellerPrice: { type: 'number', format: 'decimal', example: 48.00 },
            TotalQty: { type: 'number', format: 'decimal', example: 90.00 },
            Date: { type: 'string', format: 'date', example: '2025-08-25' },
            FatPercentage: { type: 'number', format: 'decimal', example: 3.5 },
            TotalAmount: { type: 'number', format: 'decimal', example: 4320.00 },
            CreatedAt: { type: 'string', format: 'date-time' },
            IsDeleted: { type: 'integer', example: 0 }
          }
        },
        MilkSaleRequest: {
          type: 'object',
          required: ['sellerId', 'milkType', 'sellerPrice', 'totalQty', 'date', 'fatPercentage'],
          properties: {
            sellerId: { type: 'integer', example: 1 },
            milkType: { type: 'string', enum: ['cow', 'buffalo'], example: 'cow' },
            sellerPrice: { type: 'number', format: 'decimal', example: 48.00 },
        ...
        BuyerPayment: {
          ...
          properties: {
            ...
            BuyerId: { type: 'integer', example: 1 },
            BuyerName: { type: 'string', example: 'Ramesh Kumar' },
            PaymentAmount: { type: 'number', format: 'decimal', example: 1000.00 },
            PaymentType: { type: 'string', enum: ['advance', 'full', 'partial'], example: 'advance' },
            PaymentMethod: { type: 'string', enum: ['cash', 'bank_transfer', 'upi', 'cheque'], example: 'upi' },
        ...
        BuyerPaymentRequest: {
          type: 'object',
          required: ['buyerId', 'paymentAmount', 'paymentType', 'paymentMethod', 'date'],
          properties: {
            buyerId: { type: 'integer', example: 1 },
            paymentAmount: { type: 'number', format: 'decimal', example: 1000.00 },
            paymentType: { type: 'string', enum: ['advance', 'full', 'partial'], example: 'advance' },
        ...
        Income: {
          ...
          properties: {
            ...
            Description: { type: 'string', example: 'Milk sale - 90L cow milk @ ₹48.00/L' },
        ...
        Expense: {
          ...
          properties: {
            Id: { type: 'integer', example: 1 },
            Amount: { type: 'number', format: 'decimal', example: 455.00 },
            Description: { type: 'string', example: 'Milk purchase - 10L cow milk @ ₹45.50/L' },
        ...
        FinancialOverview: {
          ...
          properties: {
            summary: {
              type: 'object',
              properties: {
                totalIncome: { type: 'number', example: 10000.00 },
                totalExpense: { type: 'number', example: 8000.00 },
                netProfit: { type: 'number', example: 2000.00 },
    ...
    tags: [
      ...
      {
        name: 'Buyers',
        description: 'Milk supplier management'
      },
      {
        name: 'Sellers',
        description: 'Milk distributor management'
      },
      {
        name: 'Milk Operations',
        description: 'Milk purchase and sales operations'
      },
      {
        name: 'Payments',
